...
class MealRepository(private val mealDao: MealDao) {
    ...
    /**
     * A suspend function that returns a simple list of all meals.
     * This is useful for one-shot operations, like in the MealPlanner.
     */
    suspend fun getAllMealsList(): List<Meal> {
        return mealDao.getAllMeals().first()
    }
     ...
     * This is a suspend function and must be a coroutine scope.
